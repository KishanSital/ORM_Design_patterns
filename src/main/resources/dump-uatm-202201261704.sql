...
CREATE TABLE `transaction` (
  ...
  `transaction_account_number` bigint(20) DEFAULT NULL,
  `transaction_amount` decimal(19,2) DEFAULT NULL,
  `transaction_card_number` bigint(20) DEFAULT NULL,
...
INSERT INTO `user` VALUES (1,'1234','kishan');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'uatm'
--
...
-- Dump completed on 2022-01-26 17:04:06
